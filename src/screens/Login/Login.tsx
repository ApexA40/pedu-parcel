          ...
          <CardContent className="p-8">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                {/* <span className="text-bg-[#007bff] font-bold text-xl">DELIVERY</span> */}
              </div>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      disabled={loading}
                      required
                      className="pl-10 pr-3 w-full rounded-lg border border-[#d1d1d1] bg-white py-2.5 [font-family:'Lato',Helvetica] font-normal text-neutral-700 placeholder:text-[#b0b0b0] focus:outline-none focus:ring-2 focus:ring-bg-[#007bff] focus:border-bg-[#007bff] disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
                </div>
              ) : (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 pr-10 w-full rounded-lg border border-[#d1d1d1] bg-white py-2.5 [font-family:'Lato',Helvetica] font-normal text-neutral-700 placeholder:text-[#b0b0b0] focus:outline-none focus:ring-2 focus:ring-bg-[#007bff] focus:border-bg-[#007bff] disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-[#d1d1d1] text-bg-[#007bff] focus:ring-bg-[#007bff]"
                  />
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-[#007bff] text-white hover:bg-bg-[#007bff]/90 mt-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
